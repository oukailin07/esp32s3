...
void ds_ui_wordpage_init(){
    ...
    strcpy(word_array.array[0].word[0],"embeded");
    strcpy(word_array.array[0].word[1],"嵌入式");

    strcpy(word_array.array[1].word[0],"senior");
    strcpy(word_array.array[1].word[1],"学长");

    strcpy(word_array.array[2].word[0],"thread");
    strcpy(word_array.array[2].word[1],"线程");

    strcpy(word_array.array[3].word[0],"likeit");
    strcpy(word_array.array[3].word[1],"点赞");
